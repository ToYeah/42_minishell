...
#    Updated: 2021/02/12 21:05:21 by nfukada          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS		:= srcs/utils/get_next_line.c srcs/utils/error.c srcs/main.c srcs/exec/exec_command.c srcs/builtin/buildin.c
OBJS		:= $(SRCS:%.c=%.o)
