...
SRCS		:= srcs/lexer/lexer_quote_state.c srcs/lexer/lexer.c srcs/lexer/lexer_general_state.c srcs/expander/expander.c srcs/expander/expand_var.c srcs/expander/expand_tokens.c srcs/main.c srcs/builtin/builtin.c srcs/builtin/mini_echo.c srcs/utils/env.c srcs/utils/error.c srcs/utils/token.c srcs/utils/token_utils.c srcs/utils/env_utils.c srcs/exec/exec.c srcs/exec/build_path.c srcs/exec/exec_pipe.c srcs/exec/build_path_utils.c srcs/exec/exec_command.c srcs/exec/command.c srcs/parser/print_node_label.c srcs/parser/node.c srcs/parser/print_node.c srcs/parser/redirect.c srcs/parser/parser_utils.c srcs/parser/parser.c 
OBJS		:= $(SRCS:%.c=%.o)
